...
Sample app showing how to use modal_progress_hud_alt in a login screen
...
## Demo
![Demo](https://github.com/mmcc007/modal_progress_hud_alt/blob/master/modal_progress_hud_alt.gif)
